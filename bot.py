...
class MyBot():
	sql = MySql("127.0.0.1", "root", "root", "mydb", "utf8")
...
def main():
	try:		
		mybot = MyBot()
		url = mybot.IndexPage(r"https://tw.stock.yahoo.com/h/getclass.php#table1")
		del(mybot)
		...
		for index in range(len(url)):
			...
			if (index == 28):
				break
			mybot.SetUrl(url.Get(index))
			mybot.InformationPage()
			del(mybot)
